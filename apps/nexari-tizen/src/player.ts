...
const Player = {
  ...
  _tizen4PanelMuted: false as boolean, // Tizen 4 safe screen-off state (panel mute, not hardware power off)
  ...
  setTizen4PanelMute(muted: boolean, source: string): boolean {
    try {
      ...
      b2b.setPanelMute(
        ...
        (e: any) => logger.warn(`[${source}] b2bcontrol.setPanelMute(${value}) error:`, (e && e.message) || e),
      );
      return true;
    } catch (e) {
