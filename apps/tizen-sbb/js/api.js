  ...
  async sendTelemetry(deviceId, data) {
    try {
      ...
      if (ws && ws.readyState === 1) {
        ...
        if (data.cpuLoad != null || data.storageFree != null || data.storageFreeBytes != null || data.firmwareVersion || data.timezone || data.resolution || data.tvName) {
          ws.send(JSON.stringify({
            type: 'heartbeat',
            payload: {
