...
const Player = {
    ...
    _liveCaptureTimer: undefined, // setInterval handle for live-view frame loop
    ...
    _zoneAVPlayers: [],
    _zoneAVPlayerMap: {},
    _zoneSyncEnabled: false,
    _zoneDocumentActive: false,
        ...
        try {
            ...
            switch (messageType) {
                ...
                case 'remote_status': {
                    ...
                    const rsRequestId = (_a = message.payload) === null || _a === void 0 ? void 0 : _a.requestId;
                    const rsWs = this.wsConnection;
                    function sendMdcStatusResponse(payload) {
                        if (rsRequestId && rsWs && rsWs.readyState === rsWs.OPEN) {
                    ...
                    if (mdcPayload && typeof mdcPayload.action === 'string') {
                        ...
                        if (action === 'b2b_pc_connection_get') {
                            try {
                                ...
                                sendMdcControlResponse({ ok: false, error: String((_d = err === null || err === void 0 ? void 0 : err.message) !== null && _d !== void 0 ? _d : err) });
                            }
                            break;
                        }
                        const xhr = new XMLHttpRequest();
                        ...
                        xhr.onload = function () {
                            try {
                                ...
                                sendMdcControlResponse(Object.assign(Object.assign(Object.assign({ ok: !!response.ok }, (response.rawHex !== undefined ? { rawHex: response.rawHex } : {})), (response.data !== undefined ? { data: response.data } : {})), (response.error !== undefined ? { error: response.error } : {})));
                            }
                            catch (error) {
    ...
    runMdcPoll() {
        ...
        for (const action of commands) {
            ...
            (function (a) {
                xhr.onload = function () {
                    try {
                        results[a] = JSON.parse(xhr.responseText);
                    }
                    catch (_a) {
                        results[a] = { ok: false };
                    }
    ...
    executeCommand(command) {
        ...
        switch (type) {
            ...
            case 'SET_VIRTUAL_STANDBY':
                ...
                break;
            case 'SET_VOLUME':
                this.invokeTVControl('setVolume', (_f = (_d = payload === null || payload === void 0 ? void 0 : payload.level) !== null && _d !== void 0 ? _d : command.level) !== null && _f !== void 0 ? _f : null);
                break;
            case 'VOLUME_UP':
                this.invokeTVControl('volumeUp', (_h = (_g = payload === null || payload === void 0 ? void 0 : payload.step) !== null && _g !== void 0 ? _g : payload === null || payload === void 0 ? void 0 : payload.amount) !== null && _h !== void 0 ? _h : 2);
                break;
            case 'VOLUME_DOWN':
                this.invokeTVControl('volumeDown', (_k = (_j = payload === null || payload === void 0 ? void 0 : payload.step) !== null && _j !== void 0 ? _j : payload === null || payload === void 0 ? void 0 : payload.amount) !== null && _k !== void 0 ? _k : 2);
                break;
            case 'MUTE':
            ...
            case 'CAST_STATUS':
                if (typeof Telemetry !== 'undefined' && Telemetry.setCastReady) {
                    Telemetry.setCastReady((_o = (_m = (_l = payload === null || payload === void 0 ? void 0 : payload.ready) !== null && _l !== void 0 ? _l : payload) !== null && _m !== void 0 ? _m : command === null || command === void 0 ? void 0 : command.ready) !== null && _o !== void 0 ? _o : null);
                }
                break;
            case 'OTT_STATUS':
    ...
    _applyHardwareNtp(server, timezone) {
        ...
        const onErr = (method) => (error) => logger.warn('[NTP] hardware NTP error via', method, (error && error.message) || error);
        if (typeof b2b.setntpuse === 'function') {
            try {
                b2b.setntpuse('use', onOk('setntpuse'), onErr('setntpuse'));
            }
            catch (error) {
                logger.warn('[NTP] setntpuse threw:', (error && error.message) || error);
            }
        }
        if (typeof b2b.setntpserveraddress === 'function') {
            try {
                b2b.setntpserveraddress(server, onOk('setntpserveraddress'), onErr('setntpserveraddress'));
            }
            catch (error) {
                logger.warn('[NTP] setntpserveraddress threw:', (error && error.message) || error);
            }
        }
        if (typeof b2b.setcurrenttimezone === 'function') {
            try {
                b2b.setcurrenttimezone(timezone, onOk('setcurrenttimezone'), onErr('setcurrenttimezone'));
                return;
            }
            catch (error) {
                logger.warn('[NTP] setcurrenttimezone threw:', (error && error.message) || error);
            }
        }
        if (typeof b2b.setNTPSync === 'function') {
            try {
                b2b.setNTPSync(server, timezone, onOk('setNTPSync'), onErr('setNTPSync'));
                return;
            }
            catch (error) {
                logger.warn('[NTP] setNTPSync threw:', (error && error.message) || error);
            }
        }
        if (typeof b2b.setClockSync === 'function') {
            try {
                b2b.setClockSync(true, server, timezone, onOk('setClockSync'), onErr('setClockSync'));
                return;
            }
            catch (error) {
                logger.warn('[NTP] setClockSync threw:', (error && error.message) || error);
            }
        }
        if (typeof b2b.setNTPServer === 'function') {
            try {
                b2b.setNTPServer(server, onOk('setNTPServer'), onErr('setNTPServer'));
            }
            catch (error) {
                logger.warn('[NTP] setNTPServer threw:', (error && error.message) || error);
            }
        }
        else if (typeof b2b.enableNTPSync === 'function') {
            try {
                b2b.enableNTPSync(server, onOk('enableNTPSync'), onErr('enableNTPSync'));
            }
            catch (error) {
                logger.warn('[NTP] enableNTPSync threw:', (error && error.message) || error);
            }
        }
        if (typeof b2b.setTimeZone === 'function') {
            try {
                b2b.setTimeZone(timezone, onOk('setTimeZone'), onErr('setTimeZone'));
            }
            catch (error) {
                logger.warn('[NTP] setTimeZone threw:', (error && error.message) || error);
            }
        }
    ...
    stopZoneMode() {
        ...
        if (this._zoneDocumentActive) {
            ...
            try {
                (_b = (_a = window.b2bapis) === null || _a === void 0 ? void 0 : _a.b2bdoc) === null || _b === void 0 ? void 0 : _b.stopDoc(() => { }, () => { });
            }
            catch (_) { }
            try {
                (_d = (_c = window.b2bapis) === null || _c === void 0 ? void 0 : _c.b2bcontrol) === null || _d === void 0 ? void 0 : _d.closeDoc(() => { }, () => { });
            }
            catch (_) { }
        }
    ...
    _playZoneOffice(zone, container, content, items, itemIndex, durationMs, token, zoneIndex) {
        ...
        const docApi = (_a = window.b2bapis) === null || _a === void 0 ? void 0 : _a.b2bdoc;
        const controlApi = (_b = window.b2bapis) === null || _b === void 0 ? void 0 : _b.b2bcontrol;
        if (!docApi) {
        ...
        const advanceOnce = () => {
            ...
            if (this._zoneDocumentActive) {
                ...
                try {
                    controlApi === null || controlApi === void 0 ? void 0 : controlApi.closeDoc(() => { }, () => { });
                }
                catch (_) { }
            }
            if (this._zoneMode && container.parentNode) {
    ...
    isSyncplayAvailable() {
        ...
        if (typeof b2bapis !== 'undefined' &&
            !!b2bapis.b2bsyncplay &&
            typeof b2bapis.b2bsyncplay.startSyncPlay === 'function' &&
            typeof b2bapis.b2bsyncplay.makeSyncPlayList === 'function' &&
            typeof b2bapis.b2bsyncplay.stopSyncPlay === 'function') {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (this.syncplayBackend === 'b2bapis') {
                    try {
                        b2bapis.b2bsyncplay.clearSyncPlayList((res) => logger.debug('Syncplay: pre-clean clearSyncPlayList ok', res === null || res === void 0 ? void 0 : res.result), (err) => logger.debug('Syncplay: pre-clean clearSyncPlayList error (ignored)', err === null || err === void 0 ? void 0 : err.message));
                    }
                    catch (e) {
                ...
                yield new Promise((resolve, reject) => {
                    ...
                    if (this.syncplayBackend === 'b2bapis') {
                        b2bapis.b2bsyncplay.makeSyncPlayList(contentsArr, onSuccess, onError);
                    }
                    else {
            ...
            try {
                ...
                if (this.syncPlayListener) {
                    try {
                        ...
                        if (this.syncplayBackend === 'b2bapis') {
                            b2bapis.b2bsyncplay.stopSyncPlay(this.syncPlayListener);
                        }
                        else {
                ...
                const invokeStart = (syncinfo) => {
                    if (this.syncplayBackend === 'b2bapis') {
                        b2bapis.b2bsyncplay.startSyncPlay(syncinfo.rectX, syncinfo.rectY, syncinfo.rectWidth, syncinfo.rectHeight, syncinfo.groupID, syncinfo.rotate, listener);
                    }
                    else {
                ...
                if (canProbeUhd) {
                    ...
                    try {
                        ...
                        try {
                            if (this.syncplayBackend === 'b2bapis') {
                                try {
                                    b2bapis.b2bsyncplay.stopSyncPlay(listener);
                                }
                                catch (_) { }
                            }
                            else {
    ...
    stopSyncPlayNative() {
        ...
        try {
            if (this.syncplayBackend === 'b2bapis') {
                b2bapis.b2bsyncplay.clearSyncPlayList((res) => logger.debug('Syncplay: clearSyncPlayList ok', res === null || res === void 0 ? void 0 : res.result), (err) => logger.debug('Syncplay: clearSyncPlayList error (ignored)', err === null || err === void 0 ? void 0 : err.message));
            }
            else {
