...
var Logic = function() {
  ...
  server.listen(PORT, '0.0.0.0', function() {
    ...
    try {
      var b2 = http.request(
        { hostname: '192.168.1.110', port: 3000, path: '/api/v1/devices/time?source=tizen-node-server-up', method: 'GET' },
