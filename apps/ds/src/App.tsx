...
import PosMediaPage from './pages/workspace/PosMediaPage.js';
...
import RuleSetsPage from './pages/workspace/RuleSetsPage.js';
  ...
  return (
    <AuthBootstrap>
      ...
      >
        ...
        <Route path="/workspaces/:wsId/pos/media" element={<PosMediaPage />} />
        ...
        <Route path="/workspaces/:wsId/rule-sets" element={<RuleSetsPage />} />
