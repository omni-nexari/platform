...
import { Building2, BarChart2, Bell, LogOut, LayoutDashboard, Palette, Menu, X, ScrollText, MessageSquare, PackageCheck, Tag, KeyRound, Activity, UserCircle, Users } from 'lucide-react';
...
const NAV = [
  ...
  { to: '/management/releases', icon: PackageCheck, label: 'App Releases', end: false as const },
  ...
  { to: '/management/license', icon: KeyRound, label: 'License', end: false as const },
  { to: '/management/monitoring', icon: Activity, label: 'Monitoring', end: false as const },
  { to: '/management/team', icon: Users, label: 'Team', end: false as const },
  { to: '/management/account', icon: UserCircle, label: 'My Account', end: false as const },
];
