...
import { Building2, BarChart2, Activity, Bell, LogOut, Layers, LayoutDashboard, Menu, X, ScrollText, Tv, ServerCog, MessageSquare, Tag } from 'lucide-react';
...
const NAV = [
  ...
  { to: '/superadmin/pricing', icon: Tag, label: 'Pricing', end: false as const },
  ...
  { to: '/superadmin/support', icon: MessageSquare, label: 'Support', end: false as const },
];
