...
import { useCmsEnabled } from '../../lib/modules.js';
import {
  Badge,
  Callout,
  ActionButton,
    ...
    <div className="space-y-6">
      ...
      {canManage && (
        <>
          ...
          {/* Plan & Billing removed — standalone deployment has no subscription billing */}
        </>
      )}
    </div>
  );
...
export default function SettingsPage() {
  ...
  const visibleSections = SECTIONS.filter((s) => (!s.cmsOnly || cmsEnabled));
