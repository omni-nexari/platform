...
<widget xmlns="http://www.w3.org/ns/widgets" xmlns:tizen="http://tizen.org/ns/widgets" id="http://nexari.app/tizen/NexariPlayer" version="1.0.22" viewmodes="maximized">
    ...
    <tizen:content-security-policy>default-src * 'unsafe-inline' 'unsafe-eval' data: blob:; script-src * 'unsafe-inline' 'unsafe-eval'; connect-src *; img-src * data: blob:; frame-src *; style-src * 'unsafe-inline';</tizen:content-security-policy>
    <tizen:content-security-policy-report-only></tizen:content-security-policy-report-only>
    <description>Nexari Signage - Samsung Smart TV (Tizen 4+)</description>
    <icon src="icon.png"/>
    <tizen:metadata key="http://samsung.com/tv/metadata/use.network" value="true"/>
    <tizen:metadata key="http://samsung.com/tv/metadata/prelaunch.support" value="true"/>
    <name>NexariTizen</name>
    ...
    <tizen:privilege name="http://samsung.com/privilege/documentplay"/>
    <tizen:privilege name="http://developer.samsung.com/privilege/avplay"/>
    <tizen:privilege name="http://developer.samsung.com/privilege/tv.audio"/>
    <tizen:privilege name="http://developer.samsung.com/privilege/systemcontrol"/>
    <tizen:privilege name="http://developer.samsung.com/privilege/timer"/>
