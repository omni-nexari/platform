...
$appId  = "NxrHtmlSnc.NexariHtml5Sync"
$wgtName = "NexariHtml5Sync.wgt"
$tmp    = "$env:TEMP\nexari-html5-sync-build"
...
# ============================================================
# Helper: connect -> uninstall -> install -> launch
# ============================================================
function Install-Html5SyncOnTV {
    ...
    Write-Host "--- Install ---"
    & $tizen install -s $tv -n $wgtName -- $src 2>&1 | Out-String | Write-Host
...
# ============================================================
Install-Html5SyncOnTV -tv $tvQBC -label "QBC"
Install-Html5SyncOnTV -tv $tvSBB -label "SBB TV"
